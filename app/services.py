...
async def create_set(day_exercise_id: int, set_order: int, target_weight: Optional[float] = None) -> schemas.SetInfo:
    ...
    set_obj = repo.create_set(day_exercise_id, set_order, target_weight)
